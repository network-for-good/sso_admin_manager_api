...
shared_examples_for "a valid admin" do
...
describe SsoAdminManagerApi::V1::AdminsController do
  ...
  describe "#update" do
    ...
    subject { post "admins/#{ identifier }", params }
    ...
    context "and it matches one admins email" do
      before do
      ...
      it_should_behave_like "a valid admin"
