...
describe SsoAdminManagerApi::V1::AdminsController do
  ...
  describe "#update" do
    ...
    context "when the id matches multiple admins" do
      ...
      let(:serialized_result) { [ActiveModelSerializers::SerializableResource.new(admin.reload, serializer: SsoAdminManagerApi::V1::AdminSerializer),
                                  ActiveModelSerializers::SerializableResource.new(admin2.reload, serializer: SsoAdminManagerApi::V1::AdminSerializer)].to_json }
